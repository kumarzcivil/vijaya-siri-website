...
import DynamicServiceSEO from "../../components/SEO/DynamicServiceSEO";
...
export default function QuickFixServiceDetailPage() {
  ...
  const price = service.pricing.enabled
    ? formatINR(service.pricing.price ?? 0)
    : null;
        ...
        <div className="section-container">
            ...
            {service.image ? (
              ...
              <div className="qfd-hero-placeholder">
                <Icon
                  ...
                  size={56}
                  className="qfd-hero-placeholder-icon"
                />
              </div>
            )}
          </div>
          ...
          <div className="qfd-layout">
              ...
              <div className="qfd-booking-card">
                ...
                {price ? (
                  <div className="qfd-booking-price">
                    ...
                    {duration && (
                      <span className="qfd-booking-unit">{duration}</span>
                    )}
                  </div>
                ) : (
                  <div className="qfd-booking-price">
                ...
                {service.pricing.priceNote && (
                  <p className="qfd-booking-note">
                    {service.pricing.priceNote}
                  </p>
                )}
                <div className="qfd-cta-group">
                  <button
                    className="qfd-cta qfd-cta--cart"
                ...
                <div className="qfd-booking-support">
                  ...
                  <span className="qfd-booking-reassure">
            ...
            {includedItems.length > 0 && (
              <section
                className="qfd-included"
                aria-labelledby="qfd-included-title"
              >
                <h2 className="qfd-section-title" id="qfd-included-title">
                  What&apos;s Included
                </h2>
