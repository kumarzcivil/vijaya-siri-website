...
const PROCESS_STEPS = [
  {
    ...
    description: "Select the work you need.",
  },
  {
    step: "02",
  ...
  },
  {
    ...
    description: "Review the estimate and get the work started.",
  },
];
...
export default function ProFixPage() {
  ...
  return (
    <>
      <SEO
        title="ProFix | Home Renovation & Construction Services | Vijaya Siri"
        description="Explore Vijaya Siri ProFix services, including home renovation, modular kitchens, flooring, painting, and other available construction solutions."
        canonical="/pro-fix"
      />
      ...
      <div className="profix-page">
              ...
              {categories.map((cat) => {
                ...
                return (
                  ...
                  >
                    ...
                    {count > 0 && (
                      <span className="profix-cat-tile-badge">{count}</span>
                    )}
                  </button>
                );
              })}
          ...
          <div className="section-container">
            <div className="profix-section-header">
              <div className="profix-section-header-text">
                ...
                <h2 className="profix-section-title">
                  Popular Pro Fix Services
                </h2>
              </div>
              <span className="profix-services-count">
                ...
                <article key={svc.id} className="profix-service-card">
                  <div className="profix-service-img">
                    {svc.imageUrl ? (
                      ...
                      <Icon
                        name={SERVICE_ICONS[svc.category] || "building"}
                        size={32}
                        className="profix-service-img-icon"
                      />
                    )}
                  </div>
        ...
        <section className="profix-process">
          <div className="section-container">
            ...
            <div
              ref={howRef}
              className={`profix-process-steps ${howVisible ? "profix-process-steps--visible" : ""}`}
            >
        ...
        <section className="profix-expert">
          <div className="section-container">
            <div className="profix-expert-card">
              <h2 className="profix-expert-title">
                Need help choosing a service?
              </h2>
              <p className="profix-expert-tagline">
                Not sure where to start? We&apos;ll point you right.
              </p>
