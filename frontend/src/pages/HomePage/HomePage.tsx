...
export default function HomePage() {
  ...
  return (
    <>
      <SEO
        title="Vijaya Siri | Construction & Home Improvement Services"
        description="Explore construction, home renovation, painting, plumbing, electrical, flooring, and modular kitchen services from Vijaya Siri in Siruguppa and selected service areas."
        canonical="/"
      />
      ...
      <div className="home-page">
          ...
          <div className="section-container">
            <div className="home-hero-inner">
              ...
              <p className="home-hero-desc">
                From concept to completion, we help you build spaces you&apos;ll
                love for life.
              </p>
        ...
        <section className="home-services" id="home-services" ref={servicesRef}>
          <div className="section-container">
            <div
              className={`home-services-header ${servicesVisible ? "home-services-header--visible" : ""}`}
            >
              <span className="home-services-label">Our Services</span>
              <h2 className="home-services-title">
                Three services. One promise — Quality Homes.
              </h2>
              ...
              {visibleServices.map((svc, i) => (
                ...
                >
                  <div className="home-service-card-content">
                    <div
                      className={`home-service-icon ${svc.primary ? "home-service-icon--primary" : ""}`}
                    >
